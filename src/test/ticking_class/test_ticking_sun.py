...
class TestTickingUniverse(unittest.TestCase):
    @unittest.skipIf(TickingSun.radiate_energy_outwards not in TickingUniverse.on_tick_methods,"Not testing disabled on_tick method")
    def test_sun_radiate_earth(self):
        ...
        sun.energy_radiated_per_second = (4 * math.pi) / (sun.solid_angle(earth) * TickingUniverse.TIME_DELTA)
